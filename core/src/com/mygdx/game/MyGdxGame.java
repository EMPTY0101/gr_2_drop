...
public class MyGdxGame extends ApplicationAdapter {
    ...
    private void spawnRaindrop() {
        ...
        raidnrop.x = MathUtils.random(0, 800 - 64);
        raindrop.y = 480;
        raindrop.width = 64;
        raindrop.height = 64;
    ...
    public void render() {
        ...
        //Создаём цикл для итерирования капель, т.е. будем отслеживать каждую созданную каплю
        //и заставлять её падать вниз в случае падения в ведро или за пределы экрана
